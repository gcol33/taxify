...
all fifteen pre-built backends (WFO, COL, GBIF, ITIS, NCBI, OTT, WoRMS,
Euro+Med, Species Fungorum, AlgaeBase, FishBase, SeaLifeBase, Reptile
Database, LCVP, and WCVP). The register contains ~500k genera, each with its family, higher
