...
is enough distance to reach *Poa trivialis* (the intended target, 2 edits)
and potentially other Poa species that happen to be closer in string distance. With 500+ Poa species in the backbone, the risk of a false match is real.
...
case for fuzzy matching. The genus *Poa* has over 500 accepted species in the backbone,
