...
| [rWCVP](https://matildabrown.github.io/rWCVP/) | World Checklist of Vascular Plants (Kew) | Vascular plants | Local snapshot | `taxify(backend = "wcvp")` for names; `add_wcvp()` for native ranges |
...
- **Multiple backbones.** taxify matches against fifteen backbones offline
...
pinning is also available: `taxify_download("wfo", version =
