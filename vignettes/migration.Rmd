...
| [lcvplants](https://cran.r-project.org/package=lcvplants) | Leipzig Catalogue of Vascular Plants | Vascular plants | Bundled in package | `taxify(backend = "lcvp")` |
...
[lcvplants](https://cran.r-project.org/package=lcvplants) wraps the
