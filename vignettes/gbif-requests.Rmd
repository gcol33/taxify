...
ordinary data frame, so you can see what every name landed on before anything
is sent:
...
The same two steps with the match folded into the first. The matched table is
still there afterwards, as `attr(dl, "taxa")`, but you commit to the request
