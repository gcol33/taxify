...
- [`add_bird_nest()`](https://gillescolling.com/taxify/reference/add_bird_nest.md)
...
- [`print(`*`<taxify_result>`*`)`](https://gillescolling.com/taxify/reference/print.taxify_result.md)
  : Print a taxify_result
- [`summary(`*`<taxify_result>`*`)`](https://gillescolling.com/taxify/reference/summary.taxify_result.md)
