# Detached launcher for algaebase backbone build.
...
$RunDir  = Join-Path $Repo "scripts\rebuild_runs\algaebase"
$Script  = Join-Path $Repo "scripts\rebuild_runs\build_algaebase.R"
